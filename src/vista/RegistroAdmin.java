...
public class RegistroAdmin extends JDialog {
	...
	public RegistroAdmin(JFrame parent) {
		super(parent, "Registro de Vendedor", true);
		setUndecorated(true); 
		setTitle("Registro de Vendedor");
		setBounds(100, 100, 493, 252);
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		getContentPane().setLayout(null);
		setLocationRelativeTo(parent);

		JLabel lblTitulo = new JLabel("Registro de Administrador");
		lblTitulo.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblTitulo.setBounds(65, 10, 233, 20);
		...
		btnRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String rol = "Admin";		//cmbRol.getSelectedItem().toString();
