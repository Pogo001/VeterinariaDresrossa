...
public class RegistroVendedor extends JDialog {
	...
	public RegistroVendedor(JFrame parent) {
		...
		JLabel lblTitulo = new JLabel("Registro de Vendedor");
		...
		btnRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String rol = "Vendedor"; // cmbRol.getSelectedItem().toString();
