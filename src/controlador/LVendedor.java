...
public class LVendedor {
	public void guardarEnArchivo(Usuario usuario) {
	    try (BufferedWriter writer = new BufferedWriter(new FileWriter(".\\Documentacion\\Vendedor.txt", true))) {
	...
	public void Consultar() {
		...
		try {
			FileReader datosLeidos = new FileReader(".\\Documentacion\\Vendedor.txt");
